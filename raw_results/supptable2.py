...
def get_performance(features,names,home,card):
    ...
    for idx,feature in enumerate(features):
        ...
        lst.append({
                    ...
                    'Variable Set 2':v2,
                    'Variable Set 3':v3,
                    '# of variables in Variable Set 1':v1c,
                    '# of variables in Variable Set 2':v2c,
                    '# of variables in Variable Set 3':v3c,
...
lst=[]
missing=[]
home=f'/data/kvhdata1/Projects/MIGHT/results/Cohort1/TestingTreesAndMaxFeatures/results/100000/0.1'
...
lst=[]
posteriors=[]
home=f'/data/kvhdata1/Projects/MIGHT/results/Cohort1/Ensembles/CustomizedEnsembles/0.1'
...
### Three View ###
##################
dir=f'/data/kvhdata1/Projects/MIGHT/results/Cohort1/Ensembles/CustomizedEnsembles/0.1'
...
for feature1,feature2 in list(zip(top[0],top[1])):
    ...
    threeview_card.extend([[cardinality_df[c1],cardinality_df[c2],cardinality_df[c3]]for c3 in feature_df['path'].tolist()])

home=f'/data/kvhdata1/Projects/MIGHT/results/Cohort1/Ensembles/CustomizedEnsembles/0.1'
threeview,threeview_posteriors,missing=get_performance(threeview_features,threeview_names,home,threeview_card)
threeview=pd.DataFrame(threeview)
...
for idx in range(len(df)):
    ...
    print(feature,feature2,feature3)
    if feature==feature2:continue
    if feature.startswith('Outside') and feature2.startswith('Outside'):continue
    if feature.startswith('Inside') and feature2.startswith('Inside'):continue
    if feature.startswith('Inside') and feature2.startswith('Congruent'):continue
...
out.to_csv(f'{results}/supptables2.csv',index=False)
