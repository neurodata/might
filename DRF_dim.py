...
DIMENSION = [2**i for i in range(2, 13)]
...
#     print(hell_dists)
    np.savetxt(
        "/home/hao/drf/trunk_auc_dim_rep{}.csv".format(
            i
        ),
        hell_dists,
        delimiter=",",
...
#     print(hell_dists)
    np.savetxt(
        "/home/hao/drf/trunk_mix_auc_dim_rep{}.csv".format(
            i
        ),
        hell_dists,
        delimiter=",",
...
#     print(hell_dists)
    np.savetxt(
        "/home/hao/drf/trunk_overlap_auc_dim_rep{}.csv".format(
            i
        ),
        hell_dists,
        delimiter=",",
