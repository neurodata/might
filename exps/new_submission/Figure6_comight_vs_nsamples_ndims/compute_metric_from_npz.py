...
def recompute_metric_n_samples(
    ...
    fname = f"results_vs_nsamples_{sim_name}_{output_model_name}_{n_dims_1}_{n_repeats}.csv"
...
if __name__ == "__main__":
    ...
    for sim_name in sim_names:
        ...
        recompute_metric_n_dims(
            root_dir, sim_name, n_samples, n_dims_2, n_repeats, n_jobs=n_jobs, overwrite=True
        )
